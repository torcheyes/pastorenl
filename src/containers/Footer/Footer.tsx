      ...
      <div className="max-w-[1200px] mx-auto">
        <div className="bg-gray-800 text-white rounded-lg p-6 mb-8 flex flex-col sm:flex-row justify-between items-center">
          <div className="mb-4 sm:mb-0 text-center sm:text-left">
            ...
            <h2 className="text-2xl font-bold">
              Professional <span className="text-orange-500">Audio Equipment</span>
            </h2>
          </div>
        ...
        <div className="border-t border-gray-300 pt-4">
          <div className="flex flex-col sm:flex-row justify-between items-center mb-4">
            ...
            <div className="flex items-center space-x-4">
              <Link href="https://twitter.com" className="text-gray-600 hover:text-gray-800">
                <Image src="/svg/social/x.svg" alt="X" width={20} height={20} />
              </Link>
              <Link href="https://instagram.com" className="text-gray-600 hover:text-gray-800">
                <Image src="/svg/social/instagram.svg" alt="Instagram" width={20} height={20} />
              </Link>
              <Link href="mailto:info@pastore.nl" className="text-gray-600 hover:text-gray-800">
                <Image src="/svg/social/mail.svg" alt="Email" width={20} height={20} />
              </Link>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm text-gray-600">
            <p className="mb-2 sm:mb-0">© 2024 PaStore. All rights reserved.</p>
            <div className="flex flex-col sm:flex-row justify-center space-y-2 sm:space-y-0 sm:space-x-4 mb-2 sm:mb-0">
              ...
              <Link href="/terms-of-use" className="hover:text-gray-800">Terms of use</Link>
              <div className="flex items-center justify-center sm:justify-start">
                <Image src="/svg/social/phone.svg" alt="Phone" width={16} height={16} className="mr-1" />
