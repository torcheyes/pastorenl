...
export function ProductForm({ initialData }: ProductFormProps) {
    ...
    const handleArrayInputChange = (index: number, field: 'features' | 'whatsInTheBox', value: string) => {
    ...
    const removeArrayItem = (index: number, field: 'features' | 'whatsInTheBox') => {
        setProductData(prev => ({
            ...prev,
    ...
    const handleSpecificationChange = (index: number, field: 'spec' | 'value', value: string) => {
                ...
                {productData.whatsInTheBox?.map((item, index) => (
                    <div key={index} className="flex space-x-2 mb-2">
                        <input
                            type="text"
                            value={item}
                            onChange={(e) => handleArrayInputChange(index, 'whatsInTheBox', e.target.value)}
                            className="w-full p-2 border rounded"
                        />
                        <button 
                            type="button" 
